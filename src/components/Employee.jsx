...
const Employee = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await axios.get("https://springbootdeployment1.onrender.com/employee", {
          headers: {
  ...
  const handleDelete = async (empId) => {
    try {
      await axios.delete(`https://springbootdeployment1.onrender.com/employee/${empId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleEditSubmit = async () => {
    try {
      await axios.put(`https://springbootdeployment1.onrender.com/employee/${editEmployee.empId}`, editEmployee, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
