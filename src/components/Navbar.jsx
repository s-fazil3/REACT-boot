...
const Navbar = () => {
  ...
  try {
    ...
    const token = localStorage.getItem("token");
    const response = await axios.get(`https://springbootdeployment1.onrender.com/api/employees/name/${searchQuery}`, {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container">
        <Link className="navbar-brand" to={isLoggedIn ? "/employee" : "/"}>Employee management system</Link>
